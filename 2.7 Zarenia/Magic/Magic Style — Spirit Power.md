...
### Synchronization
**Synchronization** is the process by which a human and Spirit align their thoughts, senses, and natural energy into a single will. The Spirit gathers and manipulates natural energy as it normally would, while the human provides conscious direction and precise control over its expression. The closer the pair's understanding of one another, the less effort is required to coordinate their actions, allowing techniques to manifest more quickly and with greater efficiency.
...
### Grades
Synchronicity is the degree to which a human and Spirit have synchronized. Higher synchronicity allows the Spirit's power to be transferred more efficiently, increasing both the quantity of energy that can be safely channeled and the precision with which it can be controlled.

##### Grade One
**Requirements:**
- Master initial synchronization (5% synchronicity)
...
##### Grade Four
**Requirements:**
- Maintain 50% synchronicity under combat conditions.
...
- **Support:** Techniques that enhance others or provide aid.
- **Ranged:** Long-range techniques.

#### Limitations
Spirits are sentient and have distinct preferences. Using them for trivial tasks may insult them. Conflicts with Spirits should be avoided to maintain optimal abilities.
